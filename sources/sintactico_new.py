...
def p_begin(p):
    '''begin : BEGIN expression RESCUE expression ENSURE expression END
...
def p_method_definitions(p):
    '''method_definitions : DEF expression expression END
                        | DEF expression LPAREN RPAREN expression END
                        | DEF expression LPAREN args_method RPAREN expression END'''
